...
class Settings:
    ...
    STOREAGE_ACCOUNT_CHECKPOINT_STORE = os.getenv('STOREAGE_ACCOUNT_CHECKPOINT_STORE')
    STOREAGE_ACCOUNT_CHECKPOINT_STORE_CONTAINER = os.getenv('STOREAGE_ACCOUNT_CHECKPOINT_STORE_CONTAINER')
